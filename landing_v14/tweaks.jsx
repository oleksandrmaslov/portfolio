...
function V13Tweaks() {
  ...
  /* flight — seam style, transit FX, seam set-pieces, doppler */
  useEffect(() => {
  ...
  }, [t.seamStyle, t.warp, t.doppler, t.slipstream, t.detonation, t.portalNode]);
  ...
  return (
    <TweaksPanel>
      ...
      />
      <TweakToggle
        label="Glyph slipstream"
        value={t.slipstream}
        onChange={(v) => setTweak("slipstream", v)}
      />
      <TweakToggle
        label="0x00 detonation"
        value={t.detonation}
        onChange={(v) => setTweak("detonation", v)}
      />
      <TweakToggle
        label="Node portal"
        value={t.portalNode}
        onChange={(v) => setTweak("portalNode", v)}
      />
