...
function leaveToUniverse() {
  ...
  const dest = returnTo === "universe" ? "Landing v11.html" : "Landing v11.html#work";
  ...
  return (
    <header className="shell pp-shell">
      ...
      <nav className="shell__nav pp-shell__nav">
        <a href="Landing v11.html#work" onClick={(e) => { e.preventDefault(); leaveToUniverse(); }}>WORK</a>
        <a href="Landing v11.html#about" onClick={(e) => { e.preventDefault(); leaveToUniverse(); }}>ABOUT</a>
        <a href="Landing v11.html#contact" onClick={(e) => { e.preventDefault(); leaveToUniverse(); }}>CONTACT</a>
...
function WaferV2App() {
  ...
  useEP2(() => {
    ...
    const rig = window.makeWaferRig(mount, { model: project.model });
    rigRef.current = rig;
