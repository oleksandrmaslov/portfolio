/* ============================================================
   M.O. SYSTEM — PROJECT PAGE WITH NODE HANDOFF
   ------------------------------------------------------------
   Project page template that speaks the generic node handoff
   protocol (mo_node_*). Arrival continues the flight's yaw across the
   page swap, and leaving flies the model back to the landing
   field it was opened from. Each canonical handoff page loads this
   file plus a small window.PAGE_CONFIG defined inline:
     ...
     window.PAGE_CONFIG = {
       ...
       photoSrc: "app/projects/components/wafer-sample.jpg",
  ...
  if (block.kind === "photo") {
    return (
      <div className="pp-body__photo">
        <AsciiPhotoFigure
          src={block.src || PC.photoSrc || "app/projects/components/wafer-sample.jpg"}
