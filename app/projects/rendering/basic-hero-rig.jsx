/* ============================================================
   M.O. SYSTEM — Basic project hero rig
   ------------------------------------------------------------
   ...
   like one continuous shot:
     ...
     · The landing handoff plays a FLIGHT: model rushes from far → the
       CANONICAL ARRIVAL POSE, freezes there, then navigates.
     · The project page boots and snaps to that exact arrival pose on
