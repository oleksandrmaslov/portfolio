/* ============================================================
   ...
   Same window.makeWaferBoard(THREE) → board API as the original,
   PLUS async loading: board.ready + board.onReady(cb). Methods are
...
(function () {
  ...
  const TARGET_FIT = 3.6;     // longest assembled edge, world units (frames like the old board)
