...
function pcLeaveToUniverse() {
  ...
  const dest = returnTo === "universe" ? "Landing Final 3.html" : "Landing Final 3.html#work";
...
function PCShell({ project }) {
  return (
    <header className="shell pp-shell">
      ...
      <a href="Landing Final 3.html" className="shell__brand pp-shell__brand"
      ...
      <nav className="shell__nav pp-shell__nav">
        <a href="Landing Final 3.html#work" onClick={(e) => { e.preventDefault(); pcLeaveToUniverse(); }}>WORK</a>
        <a href="Landing Final 3.html#about" onClick={(e) => { e.preventDefault(); pcLeaveToUniverse(); }}>ABOUT</a>
        <a href="Landing Final 3.html#contact" onClick={(e) => { e.preventDefault(); pcLeaveToUniverse(); }}>CONTACT</a>
