...
function LandingApp() {
  ...
  // The ARRIVAL overture (field gathers into "0x00" → burst → scatter) is no
  // longer fired from here. landing_final4/preloader.js triggers it the moment
  // the page is genuinely ready and time-locks its own counter to the burst,
  // so 0xFF and the explosion land on the same frame.
