...
function TitleScreenV2() {
  ...
  return React.createElement("section", {
    ...
    "data-mo-cursor-mirror": true,
    "data-mo-cursor-opacity": ".title__idTop,.title__stage,.lp"
  }, "PRODUCT SYSTEMS \xB7 EMBEDDED \xB7 INTERACTION")), React.createElement(FieldGuideT2, {
    dismissed: touched,
    touch: showExplore
  }), explore && React.createElement(ExploreOverlayT2, {
  ...
  }, showExplore ? "tap · or swipe up to continue" : "press \u21B5 \xA0\xB7\xA0 or scroll at the edges"))), React.createElement(TitleKeyboardShortcutV2, {
    onProceed: proceed
  }));
}
